...
const EFEITO_OPTS = [
  ...
  {val:'col_marcha',  label:'Col. marcha',  cls:'bg-orange-600 hover:bg-orange-500 text-white'},
  {val:'col_fala',    label:'Col. fala',    cls:'bg-purple-600 hover:bg-purple-500 text-white'},
  {val:'col_outros',  label:'Col. outros',  cls:'bg-rose-700 hover:bg-rose-600 text-white'},
];
    ...
    <div className="fixed inset-0 z-[60] bg-slate-950 text-slate-100 flex flex-col overflow-hidden" onKeyDown={onKeyDown} tabIndex={-1} style={{outline:'none'}}>
      ...
      {phase==='extract' && (
        <div className="flex-1 flex gap-0 min-h-0 overflow-hidden">
          ...
          {/* Right: form */}
          <div className="flex-1 flex flex-col bg-slate-900 min-h-0 overflow-y-auto">
...
export { ExtractorModal };<ProgrammingEditor
                    dadosGrupos={current}
                    setDadosGrupos={(newG) => {
                      const resolved = typeof newG === 'function' ? newG(current) : newG;
                      setCaptured(prev => ({...prev, [consultIdx]: {...(prev[consultIdx]||{}), editedGrupos: resolved}}));
                    ...
                    tipoEletrodo={tipoEletrodoGlobal}
                    sessaoAnteriorGrupos={prevGrupos}
                  />mport React, { useState, useRef, useCallback, useMemo, useEffect } from 'react';
import { ORDEM_TEXTO_BAIXO_CIMA, getContatosIniciais } from './constants';
import { ProgrammingEditor } from './ProgrammingEditor';
